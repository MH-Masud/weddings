<template>
  <div>
    ...
    <div class="profile-mobile"><div class="container mt-3 mt-sm-5">
        <div class="row">
          <div class="col-md-10" v-if="invitationList.data">
                        ...
                        <div class="conncet-button-head">
                          <a href="#">
                            <div class="conncet-now">
                              ...
                              >
                                <img
                                  src="/assets/frontend/img/conversation.png"
                                  width="40"
                                  height="40"
                                />
                              </a>
                              <span class="mb-2"> Write Message</span>
                            </div>
                          </a>
                          <a href="#">
                            <div class="conncet-now">
                              ...
                              <span class="mb-2">View Contact</span>
                            </div>
                          </a>
                        </div>
                      </div>
        ...
        >
          <div class="text-center p-5" v-if="resultNotFount">
            <img
              ...
              width="300"
            />
            <h5 class="mt-3">There are no Accepted Invitations</h5>
          ...
          <!-- Shine Effect -->
          <div v-else class="match-lists shadow-sm mb-2 bg-body rounded p-3 p-md-0">
                <div class="row">
                <div class="col-md-3">
                    <div class="match-list-image-inbox p-3 mb-2">
        ...
        <div class="col-md-12">
          <div class="result-notfound">
            <div class="d-grid gap-2 d-md-block">
              <pagination align="center" size="default" :data="invitationList" @pagination-change-page="getInvitationList"></pagination>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    getInvitationList(page = 1) {
      axios
        .get(
          "api/accepted-invitations/"+localStorage.getItem('memberToken')+"?page="+page)
        .then((response) => {
