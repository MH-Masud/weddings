                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" onkeyup="return createSlug()" id="name" name="name" value="{{ old('name') }}" placeholder="Category name" required>
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <br>
                                            <img class="d-none" alt="category image" id="upload_image" width="100" height="100">
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    <a href="{{ route('blog-category.index') }}" class="btn btn-dark">Blog Category List</a>
                                    <button class="btn btn-primary ml-auto" type="submit">Add Blog Category</button>
                                </div>
                            </form>
                            <script>
