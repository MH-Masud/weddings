                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('city.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="City name" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{ old('postal_code') }}" placeholder="Postal Code" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                ...
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    ...
                                    <button class="btn btn-primary ml-auto" type="submit">Add City</button>
                                </div>
                            </form>
                            <script>
