                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('email-setup.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="body" id="body" rows="10" class="form-control" placeholder="Body" required>{{ old('body') }}</textarea>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                ...
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    ...
                                    <button class="btn btn-primary ml-auto" type="submit">Add Email Setup</button>
                                </div>
                            </form>
                            <script>
