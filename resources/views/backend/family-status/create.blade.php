                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('family-status.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Family status name" required>
