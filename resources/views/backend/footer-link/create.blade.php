                        ...
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('footer-link.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" onkeyup="return createSlug()" id="name" name="name" value="{{ old('name') }}" placeholder="Page name" required>
                                        ...
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <div class="input-group">
                                                <textarea name="long_description" class="js-summernote" id="saveToLocal"></textarea>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                ...
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    ...
                                    <button class="btn btn-primary ml-auto" type="submit">Add Page</button>
                                </div>
                            </form>
                            <script>
