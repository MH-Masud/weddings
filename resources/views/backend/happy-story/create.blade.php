                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('happy-story.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="autocomplete" name="member_name" value="" placeholder="Member name" required>
                                                <input type="hidden" class="form-control" id="selectuser_id" name="posted_by" value="">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="partner_name" name="partner_name" value="{{ old('partner_name') }}" placeholder="Partner name" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="file" accept="image/png, image/jpg, image/jpeg" class="form-control" id="uploadImage" name="image1" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
