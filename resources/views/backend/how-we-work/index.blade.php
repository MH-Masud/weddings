                ...
                <div id="panel-5" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content p-0">
                            <form class="needs-validation" novalidate method="POST" action="{{ route('how-we-work.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="panel-content">
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <br>
                                            <img src="" alt="image" id="upload_image" class="d-none" height="24" width="24">
                                        </div>
                                        <div class="col-md-6 mb-6">
                                ...
                                <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                                    <button class="btn btn-primary ml-auto" type="submit">Save How We Work</button>
                                </div>
                            </form>
                            <script>
            ...
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <!-- datatable start -->
                            <table id="how_we_work_list" class="table table-bordered table-hover table-striped w-100">
