                                ...
                                <div class="panel-content">
                                    <div class="form-row">
                                        <div class="col-md-6 mb-6">
                                            <label class="form-label" for="member_name">Customer Name <span class="text-danger">*</span> </label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fal fa-object-ungroup fs-xl"></i></span>
                                                </div>
                                                <input type="text" class="form-control"  id="member_name" name="member_name" value="{{ old('member_name') }}" placeholder="Member name" required>
                                                <input type="hidden" name="member_id" id="selectuser_id">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" step="any" onkeyup="return calculateDue()" class="form-control"  id="paid" name="paid" placeholder="Paid amount" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" step="any" class="form-control"  id="due" name="due" placeholder="Due amount" required>
                                                <div class="valid-tooltip">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-tooltip">
